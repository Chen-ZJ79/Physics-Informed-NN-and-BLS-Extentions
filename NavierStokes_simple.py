from BraodLearningSystem import BLS
import sys
...
class PhysicsInformedNN:
    ...
    def neural_net(self,x,y):
        ...
        print(mappingdata.shape, enhancedata.shape)
    ...
    def net_NS(self, x, y, t, u, v):
        lambda_1 = self.lambda_1
        lambda_2 = self.lambda_2
        train_X = tf.concat([x,y,t], 1)
        train_Y = tf.concat([u,v],1)
        psi_and_p = self.neural_net(train_X,train_Y)
        psi = psi_and_p[:, 0:1]
        p = psi_and_p[:, 1:2]
        print("----------------------------------------------------------------")
        print(psi.shape, y.shape, p.shape, x.shape)
    ...
    def train(self, nIter):
        ...
        print("Type of nIter:", type(nIter))
...
if __name__ == "__main__":
    ...
    # savefig('./figures/NavierStokes_data1')
    ...
    ax.text(0.3, 0.5, s)
    plt.show()
    # savefig('./figures/NavierStokes_prediction1')
